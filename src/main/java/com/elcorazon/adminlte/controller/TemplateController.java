...
public class TemplateController {
   ...
   /******************************************************************************************************************/
    ...
    public String template(Model model) throws Exception {
        ...
        Settings settings = Images.getSettings("", "", Images.getCurrentWatermarks(watermarks_top), Images.getCurrentWatermarks(watermarks_bottom));

        settings = new com.elcorazon.adminlte.utils.Settings(environment).load(settings, "", watermarks_top, watermarks_bottom, false);
